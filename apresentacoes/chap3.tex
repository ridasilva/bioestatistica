...
A \textbf{função de probabilidade} (fp) da v.a discreta \(X\), que
assume os valores \(x_1, x_2, \ldots, x_n, \ldots\), é a função que
atribui probabilidades a cada um dos possíveis valores:
\(\{[x_i, p(x_i)], i = 1, 2, ...\}\), ou seja,
...
em \(n\) provas de Bernoulli será então a distribuição binomial, dada
por \[
