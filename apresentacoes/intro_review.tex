...
\\~\\
  \begin{itemize}
  \uncover<1->{\item
    \(N = \frac{3 \times E+3 \times P1+4 \times P2}{10}\), onde \(E=\frac{1}{n}\sum_{i=1}^nN_i\) representa \textbf{atividades feitas em sala de aula}, e \(P\) representa as provas 1 e 2;}
  \uncover<2->{\item
