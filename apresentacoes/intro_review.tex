...
\\~\\
  ...
  \uncover<4->{\item
    Dúvidas podem ser enviadas por email: \href{mailto:ridasilva@usp.br}{ridasilva@usp.br}, Monitora - \href{mailto:thalitarochael@usp.br}{joao.vitor.ferreira@usp.br}}
  \end{itemize}
