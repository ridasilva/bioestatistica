...
\\~\\
  ...
  \uncover<4->{\item
    Dúvidas podem ser enviadas por email: \href{mailto:ridasilva@usp.br}{ridasilva@usp.br}, Monitora - \href{mailto:isabelav.amatto@usp.br}{isabelav.amatto@usp.br}}
  \end{itemize}
...
\\~\\
  \begin{itemize}
  \uncover<1->{\item
    \(N = \frac{E+4.5 \times P1+4.5 \times P2}{10}\), onde \(E=\frac{1}{n}\sum_{i=1}^nN_i\) representa \textbf{as listas de exercícios}, e \(P\) representa as provas 1 e 2;}
  \uncover<2->{\item
   ...
   \uncover<3->{\item
    ...
    \uncover<4->{\item
    Projeto do curso para substituir uma prova?}    
  \end{itemize}
